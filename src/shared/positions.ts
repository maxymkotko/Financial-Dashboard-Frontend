...
const positions: PositionsType[] = [
	...
	},
	{
		...
		bubbleChildLineX: [23, 27, 25.5, 28],
	...
	},
	{
		bubbleCategoryX: 20,
		bubbleCategoryY: 53,
		bubbleCategoryLineX: 19,
		bubbleCategoryLineY: 48.5,
		bubbleCategoryLineW: 15,
		bubbleCategoryLineD: 130,
		bubbleChildX: [],
		bubbleChildY: [],
		bubbleChildLineX: [],
